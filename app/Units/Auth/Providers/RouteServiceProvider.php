...
use Confee\Units\Auth\Routes\Api;
use Confee\Units\Auth\Routes\Console;
use Confee\Units\Auth\Routes\Web;
...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Confee\Units\Auth\Http\Controllers';
